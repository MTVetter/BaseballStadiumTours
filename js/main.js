...
function createMap() {
  ...
  var CartoDB_Positron = L.tileLayer(
    "https://cartodb-basemaps-{s}.global.ssl.fastly.net/light_all/{z}/{x}/{y}.jpg",
    {
      attribution:
  ...
  var infoPopup = L.popup({ maxHeight: "300", className: "help" }).setContent(
    "<h3>How to operate the map:</h3>" +
  ...
  L.easyButton('<span class="fas fa-info-circle fa-lg"</span>', function(
    btn,
    map
  ) {
  ...
  var featureLayer = L.geoJson(data, {
    ...
    onEachFeature: function(feature, layer) {
      layer.on("click", function(e) {
        ...
        $(".boxscore1").attr("src", feature.properties.Boxscore);
...
//Create another slide show for the boxscores
var slideIndex2 = 1;
...
function showSlides2(n) {
    var i;
    var slides = document.getElementsByClassName("boxscore");
